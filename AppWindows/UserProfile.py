...
class UserProfile():
    ...
    def OpenProfileEditor(self,root):
        ...
        self.changeusernamelabel1 = customtkinter.CTkLabel(root,text=Utilities.Translations("userprofile",3),bg_color="#171d25",fg_color="#171d25",text_color="white",font=("Arial",18))
        self.changeusername = customtkinter.CTkEntry(root,width=600,height=45,corner_radius=5,placeholder_text=Utilities.Info("username"),bg_color="#171d25",fg_color="#171d25",text_color="White")
        
        self.locationslabel = customtkinter.CTkLabel(root,text=Utilities.Translations("userprofile",4),bg_color="#171d25",fg_color="#171d25",text_color="white",font=("Arial",18))
        self.changelocation = customtkinter.CTkComboBox(root,width=600,height=45,corner_radius=5,bg_color="#272d37",fg_color="#272d37",text_color="white",font=("Arial",18),values=Static.Countries,state="readonly")
        ...
        self.changeusernamelabel1.place(x=140,y=220);UsedWidgets.current.append(self.changeusernamelabel1)
        self.changeusername.insert(0, Utilities.Info("username"));self.changeusername.place(x=140,y=250);UsedWidgets.current.append(self.changeusername)

        self.locationslabel.place(x=140,y=320);UsedWidgets.current.append(self.locationslabel)
        self.changelocation.place(x=140,y=350);UsedWidgets.current.append(self.changelocation);self.changelocation.set(Utilities.Info("country").capitalize())
    ...
    def SaveChanges(self,root):  
        Editor.SaveChanges(self.changeusername.get(),self.changelocation.get())       
